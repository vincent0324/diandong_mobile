...
var Guide = function () {
    ...
    _createClass(Guide, [{
        ...
        value: function bindEvent() {
            (0, _jquery2.default)('.filter-sub-tab a').on('click', function () {
                var index = (0, _jquery2.default)(this).parents('.filter-sub-tab').find('a').index(this);
